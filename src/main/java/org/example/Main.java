    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            Cliente cliente2 = Cliente.builder()
                    ...
                    .dni(23).
                    build();
            Domicilio domi1 = Domicilio.builder().nombreCalle("siempre viva").numero(123).build();
            Domicilio domi2 = Domicilio.builder().nombreCalle("siupata").numero(44).build();

            cliente1.setDomicilio(domi1);
            domi2.setCliente(cliente2);
            cliente2.setDomicilio(domi2);
